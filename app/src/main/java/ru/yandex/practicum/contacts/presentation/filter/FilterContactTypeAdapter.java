...
//отвечает за список типов контактов, по которым их можно отфильтровать
...
//    static class ListDiffCallback extends DiffUtil.ItemCallback<FilterContactTypeUi> { //общий класс
//
//        @Override
